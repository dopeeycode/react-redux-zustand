    ...
    <>
      ...
      <div className="flex flex-col items-center py-10 w-[304px]">
        ...
        <button
          ...
          className="py-2 px-6 mt-6 bg-zinc-800 border-transparent text-sm leading-6 rounded-md 
          hover:bg-zinc-600 transition-colors focus:ring-2 focus:ring-offset-2focus:ring-offset-zinc-900 
          focus:ring-brand-500 font-medium"
        >
          Quero enviar outro
        </button>
      </div>
